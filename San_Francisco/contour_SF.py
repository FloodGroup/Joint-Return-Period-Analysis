...
def auto_assign_rainfall_files(str(DATA_DIR)):
    """Internal helper."""
    tide_stations = []
    rainfall_stations = []
    ...
    station_configs = [
        {
            ...
            'title': '9414290',
            'x_max': 3,  # Max sea level (m) - relative to common datum
            'y_max': 150,  # Max rainfall (mm)
            'datum_offset': -1.804,  # Example:datum below reference: use negative offset
            'enabled_distributions': [
                'beta', 'fisk', 'expon', 'gumbel_r', 'gamma', 'genextreme', 
                'invgauss', 'logistic', 'loglogistic', 'lognorm', 'nakagami', 
                'norm', 'rayleigh', 't', 'weibull_min', 'genpareto'
        ...
        },
        {
            ...
            'title': '9414523',
            'x_max': 3.5,  # Max sea level (m) - relative to common datum
            'y_max': 150,  # Max rainfall (mm)
            'datum_offset': -2.414,  # set per station datum
            'enabled_distributions': [
                 'fisk', 'gumbel_r', 'genextreme', 'gamma','nakagami', 
                'invgauss', 'logistic', 'loglogistic', 'lognorm',  
                'norm', 'rayleigh', 't', 'weibull_min', 'genpareto'
            ]
        },
        {
            ...
            'x_max': 3,  # Max sea level (m) - relative to common datum
            'y_max': 150,  # Max rainfall (mm)
            'datum_offset': -3.528,  # set per station datum
            'enabled_distributions': [
                'fisk','gumbel_r', 'gamma', 'genextreme', 
                'invgauss', 'logistic', 'loglogistic', 'lognorm', 'nakagami', 
                'norm', 'rayleigh', 't', 'weibull_min', 'genpareto'
            ]
        },
        {
            ...
            'x_max': 3.5,  # Max sea level (m) - relative to common datum
            'y_max': 150,  # Max rainfall (mm)
            'datum_offset': -1.086,  # set per station datum
                         'enabled_distributions': [
                 'gumbel_r','genextreme', 'gamma',
        ...
        },
        {
            ...
            'x_max': 3.5,  # Max sea level (m) - relative to common datum
            'y_max': 150,  # Max rainfall (mm)
            'datum_offset': -0.88,  # set per station datum
            'enabled_distributions': [
                 'fisk', 'gumbel_r', 'genextreme', 'gamma','nakagami', 
                'invgauss', 'logistic', 'loglogistic', 'lognorm',  
                'norm', 'rayleigh', 't', 'weibull_min', 'genpareto'
